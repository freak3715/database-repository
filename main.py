...
def index():
    ...
    with get_connection() as conn:
        with conn.cursor() as cur:
            ...
            # 検索機能
            if query:
                sql += " AND (item_name ILIKE %s OR address ILIKE %s)"
    ...
    # ★ render_template に today=date.today() を追加してHTMLに渡す
    ...
    return render_template('index.html', deliveries=data, query=query, status_filter=status_filter)
